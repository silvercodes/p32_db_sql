USE [p32_company_db]
GO
/****** Object:  Table [dbo].[departments]    Script Date: 11.03.2025 21:51:20 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[employees]    Script Date: 11.03.2025 21:51:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[positions]    Script Date: 11.03.2025 21:51:20 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[employees] ([id], [name], [birthday], [email], [position_id], [department_id], [hire_date], [manager_id], [last_name], [first_name], [middle_name], [salary], [bonus_percent], [extra_percent]) VALUES (1001, N'Петров П.П.', CAST(N'1983-12-03' AS Date), N'p.petrov@mail.com', 3, 3, CAST(N'2023-11-15' AS Date), 1000, N'Петров', N'Петр', N'Петрович', 1500, 15, NULL)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ_Employees_Email]    Script Date: 11.03.2025 21:51:20 ******/
